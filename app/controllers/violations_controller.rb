class ViolationsController < ApplicationController
  ...
  def import
    ...
    redirect_to root_url, notice: "Violation data successfully imported"
  end
  ...
  private
    ...
    def violation_params
      params.require(:violation).permit(:violation_id, :inspection_id, :violation_category, :violation_date_closed, :violation_type)
    end
end
